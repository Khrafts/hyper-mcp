...
export enum ErrorCode {
  ...
  // Community system errors (2000-2099)
  COMMUNITY_PROTOCOL_VALIDATION_FAILED = 2000,
  COMMUNITY_PROTOCOL_LOAD_FAILED = 2001,
  COMMUNITY_PROTOCOL_NOT_FOUND = 2002,
  COMMUNITY_PROTOCOL_ALREADY_LOADED = 2003,
  COMMUNITY_PROTOCOL_UNLOAD_FAILED = 2004,
  COMMUNITY_TOOL_REGISTRATION_FAILED = 2005,
  COMMUNITY_GITHUB_INTEGRATION_ERROR = 2006,
  COMMUNITY_WEBHOOK_VALIDATION_FAILED = 2007,
  COMMUNITY_SUBMISSION_PROCESSING_ERROR = 2008,
  COMMUNITY_SCHEMA_GENERATION_FAILED = 2009,
  COMMUNITY_TOOL_GENERATION_FAILED = 2010,
  COMMUNITY_PROTOCOL_DUPLICATE_NAME = 2011,
  COMMUNITY_PROTOCOL_DUPLICATE_ENDPOINT = 2012,
  COMMUNITY_PROTOCOL_INVALID_VERSION = 2013,
  COMMUNITY_CONFIGURATION_ERROR = 2014,
